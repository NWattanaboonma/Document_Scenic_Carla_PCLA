...
# AI implementation for the CARLA simulator
behavior AIAgentBehavior(agent_name, route=None):
    """
    Behavior causing a vehicle to be controlled by a specified PCLA AI agent.
    
    Args:
        agent_name (str): Name of the AI agent to use (e.g., "tfpp_l6_", "tfpp_lav_", "if_if")
        route: Optional route for the AI agent to follow
    """
    take SetAIAgentAction(agent_name, route)